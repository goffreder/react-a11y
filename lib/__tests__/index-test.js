...
describe('tags', () => {
    ...
    describe('input', () => {
        it('warns if theres no ID attribute', () => {
            expectWarning(assertions.tags.input.MISSING_ID.msg, () => {
                <input />;
            });
        });

        it('does not warn if it has ID attribute', () => {
            doNotExpectWarning(assertions.tags.input.MISSING_ID.msg, () => {
                <input id="foo"/>;
            });
        });

        // it('does not warn if it has ID attribute', () => {
        //     doNotExpectWarning(assertions.tags.input.MISSING_LABEL.msg, () => {
        //         <div>
        //             <input id="foo"/>
        //         </div>;
        //     });
